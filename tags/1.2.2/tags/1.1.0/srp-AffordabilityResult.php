...
$deductions_ .= '</small></div>';
	...
	$output .= $deductions_;
	$output .= '<p><small>Disclamer: the calculations are estimated and can only be used as guidance. For specific information contact your real estate agent or lending company.</small></p>';
}
